...
function findExportDeclarationsForJsx(source) {
    const variables = (0, find_nodes_1.findNodes)(source, ts.SyntaxKind.VariableDeclaration);
    const variableStatements = (0, find_nodes_1.findNodes)(source, ts.SyntaxKind.VariableStatement);
    const fns = (0, find_nodes_1.findNodes)(source, ts.SyntaxKind.FunctionDeclaration);
    const cls = (0, find_nodes_1.findNodes)(source, ts.SyntaxKind.ClassDeclaration);
    const exportDeclarations = (0, find_nodes_1.findNodes)(source, ts.SyntaxKind.ExportDeclaration);
    let componentNamesNodes = [];
    exportDeclarations.forEach((node) => {
        componentNamesNodes = [
            ...componentNamesNodes,
            ...(0, find_nodes_1.findNodes)(node, ts.SyntaxKind.ExportSpecifier),
        ];
    });
    ...
    const nodesContainingJSX = all.filter((x) => {
        foundJSX = (0, find_nodes_1.findNodes)(x, [
    ...
    const exported = nodesContainingJSX.filter((x) => {
        var _a, _b, _c;
        foundExport = (0, find_nodes_1.findNodes)(x, ts.SyntaxKind.ExportKeyword);
        if (x.kind === ts.SyntaxKind.VariableStatement) {
            const nameNode = (_a = (0, find_nodes_1.findNodes)(x, ts.SyntaxKind.VariableDeclaration)) === null || _a === void 0 ? void 0 : _a[0];
